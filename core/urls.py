...
urlpatterns = [
    ...
    path('full_crop/<int:card_id>', views.full_crop, name="full_crop"),
    ...
    path('hold_card/<int:csr_id>/', views.hold_card, name='hold_card'),
    path('list_card/<int:csr_id>/', views.list_card, name='list_card'),
