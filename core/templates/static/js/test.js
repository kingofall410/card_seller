document.addEventListener("DOMContentLoaded", () => {
    ...
    targets.forEach(img => {
        ...
        const rotate180Btn = document.getElementById(`rotate-180-${cardId}`);
        ...
        rotate180Btn.addEventListener("click", function () {
            console.log("180", currentRotation)
            currentRotation = (currentRotation + 180) % 360;
            
            cropper.rotateTo(currentRotation);
        });
        saveBtn.addEventListener("click", function () {
            console.log("click", cardId, currentRotation)
            save(cropper, cardId)
        });
...
function save(cropper, cardId, currentRotation) {
